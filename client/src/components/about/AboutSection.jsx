...
function AboutSection() {
  return (
    <section className='grid overflow-hidden mt-6 md:mt-0 pb-12 mx-4'>
        ...
        <section className='-mx-4 flex flex-wrap items-center justify-between'>
          ...
          <main className='w-full px-4 lg:w-1/2 xl:w-5/12'>
            <article className='mt-10 lg:mt-0'>
              ...
              {/* CTA BUTTONS */}
              <section className='grid p-2 md:p-0 md:flex gap-3 w-full'>
                <Link
                  to='/contact'
                ...
                >
                  ...
                  <span class='absolute inset-0 w-full h-full bg-slate-200 rounded-md '></span>
