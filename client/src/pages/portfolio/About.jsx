  ...
  return (
    ...
    >
      ...
      <main className='h-[1fr] grid md:grid-cols-reg w-full gap-8 px-8 my-auto py-10'>
        ...
        <section className='grid gap-10 w-full lg:px-10 select-none'>
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-4 select-none'>
            <article className='bg-gray-900 rounded-xl border-4 border-solid border-purple-600 cursor-pointer hover:bg-black hover:text-white text-white hover:outline-4 hover:outline-transparent-purple hover:outline text-center px-4 py-8 w-full select-none'>
            ...
            <article className='bg-gray-900 rounded-xl border-4 border-solid border-yellow-500 cursor-pointer hover:bg-black hover:text-white text-white hover:outline-4 hover:outline-transparent-yellow hover:outline text-center px-4 py-8 w-full select-none'>
              <div className='flex justify-center mb-4'>
            ...
            <article className='bg-gray-900 text-white rounded-xl border-4 border-solid border-green-600 cursor-pointer hover:bg-black hover:text-white hover:outline-4 hover:outline-transparent-green hover:outline text-center px-4 py-8 w-full select-none'>
              <div className='flex justify-center mb-4'>
