        ...
        {portfolioData.map((item, index) => {
          return (
            ...
            >
              ...
              <section className='grid md:grid-cols-rev gap-2'>
                <div className='relative'>
                  <img
                    className='w-full rounded-xl lg:min-h-[180px] object-fill'
                    src={item.image}
                    onClick={() => displayInfo(item)}
                    alt='portfolio item'
                  />

                  <div className='flex absolute top-0 right-0 m-1 py-1 px-2 bg-main-colour rounded-full'>
