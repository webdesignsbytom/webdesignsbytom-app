...
export const portfolioData = [
  {
    ...
    skills: [
      { name: 'Responsive Gallery', icon: `<e` },
      { name: '3D Design Tool', icon: `$` },
      { name: 'Image Slider on loop', icon: `$` },
      { name: 'User Authentication', icon: `$` },
      { name: 'Advanced CSS colour manipulating', icon: `$` },
    ],
  ...
  //     [
  //       {
  //         name: 'Array Comparisons and methods',
  //       },
  //       {
  //         icon: `$`,
  //       },
  ...
  //     [
  //       {
  //         name: 'Banking - deposit + withdrawal',
  //       },
  //       {
  //         icon: `$`,
  //       },
